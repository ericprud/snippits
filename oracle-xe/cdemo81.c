#ifdef RCSID
static char *RCSid =
   "$Header: rdbms/demo/cdemo81.c /st_rdbms_pt-112xe/1 2010/10/01 20:35:43 aliu Exp $ ";
#endif /* RCSID */
 ...
 *  "ename" added to department "dname" as employee # "empno"
   ...
   MODIFIED   (MM/DD/YY)
   aliu        10/01/10 - fix lint issue : include oratypes.h
   aliu        10/01/10 - change back to scott/tiger since hr/hr does not 
                          work in 11.2xe 
   ...
   aliu        09/30/10 - XbranchMerge aliu_oci_demo_xe_shiphome from
                          st_rdbms_10.2xe
